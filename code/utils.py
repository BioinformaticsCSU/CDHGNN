...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model,num_epoch):
        ...
        torch.save(model.state_dict(), self.savepath + '/valid_best_checkpoint.pth') # save model parameters
        # torch.save(model, self.savepath + '/valid_best_checkpoint.pth') # save whole model
